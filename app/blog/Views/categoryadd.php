            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-user" id="name" tabindex="0" placeholder="Nama kategori" name="name" value="<?php echo isset($data) && isset($data->name) ? $data->name : '' ?>">
                    </div>
                    <div class="form-group">
                        <label for="contentarticle">Deskripsi</label>
                    ...
                    <div class="form-group">
                        ...
                        <select name="parent" id="parent" class="form-control form-control-user">
                            <option value="">Opsional, pilih kategori induk</option>
...
<script>
    function save(){
        axios.post("<?= base_url('blog/category/add') ?>", {
            name: $('#name').val(),
            description: $('#contentarticle').val(),
            parent: $('#parent').val(),
    ...
    function successins(success = true) {
        if (success) {
            Swal.fire({
                title: 'Berhasil menambah data Kategori!',
                text: "Tekan ok untuk kembali",
                icon: 'success',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                confirmButtonText: 'Kembali ke halaman list Kategori',
                cancelButtonText: "Input kategori lainnya"
            }).then((result) => {
                if (result.isConfirmed) {
                    window.history.href = <?= base_url('blog/categories') ?>;
                } else {
