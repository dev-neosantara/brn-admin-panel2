    ...
    private function insertarticle($img)
    {
        ...
        try {
            ...
            if ($db->transStatus() === false) {
                ...
                $db->transCommit();
                return ['error' => 0, 'message' => 'Berhasil menambahkan artikel!'];
            }
            return ['error' => 1, 'message' => 'Gagal menambahkan artikel!'];
        } catch (\Exception $e) {
            return ['error' => 1, 'message' => $e->getMessage()];
        }

        return ['error' => 1, 'message' => 'Gagal menambahkan data artikel!'];
    }
