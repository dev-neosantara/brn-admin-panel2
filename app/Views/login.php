...
<head>
    ...
    <title><?= $_SESSION['settings']['app_name']['value'] ?></title>
    ...
    <style>
        .bg-login-image{
            background-image: url('<?= base_url() ?>/img/logo-brn.png');
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Buser Rental Nasional</h1>
                                    </div>
                                    ...
                                    <?php if ($config->validFields === ['email']): ?>
                                        ...
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                ...
                                                placeholder="Masukan Email Address..." name="login">
                                        </div>
                                        <?php else: ?>
                                            <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="Masukan Username/Email Address..." name="login">
                                        </div>
                                            <?php endif; ?>
                                        <div class="form-group">
