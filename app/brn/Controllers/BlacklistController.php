...
class BlacklistController extends \App\Controllers\BaseAdmin
{
    ...
    {
        echo view('Brn\Views\blacklist\list');
    }
    ...
    public function form($id = null)
    {
        ...
        if ($id !== null) {
            $data = $db->table('perpetrators')->where('id', $id)->get()->getRowObject();
            echo view('Brn\Views\blacklist\form', ['data_id' => $id, 'data' => $data, 'case_reports' => []]);
        } else {
            echo view('Brn\Views\blacklist\form', ['case_reports' => []]);
        }
    }
    ...
    public function listajax()
    {
        ...
        $builder = $db->table('perpetrators as per')->select('per.name, per.nik, per.profile_photo_path, users.email as email, per.id')->join('users', 'per.created_by_id = users.id', 'left');
