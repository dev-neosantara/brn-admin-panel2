...
<div class="card-body">
    <div class="border rounded-lg p-4 mb-8">
            <div class="row">
                <div class="col-sm-2">Nama Acara</div>
                <div><h3><?= $data->title ?></h3></div>
            </div>
            <div class="row">
                <div class="col-sm-2">Deskripsi</div>
                <div class="col-sm-10 p-4 border rounded-lg my-2"><h3><?= $data->description ?></h3></div>
            </div>
            <div class="row">
                <div class="col-sm-2">Waktu Acara</div>
                <div><h3><?= $data->start_date ?></h3></div>
            </div>
        </div>
    </div>
</div>
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Attendant Event <?= isset($title) ? $title : "" ?></h6>
    </div>
...
<script>
    ...
    $(document).ready(function() {
        eventTable = $('#eventsTable').DataTable({
            ...
            serverSide: true,
            language: {
                emptyTable: "Tidak/belum ada member yang mengikuti event ini!"
            },
            order: [], //init datatable not ordering
            ajax: {
                url: "<?php echo site_url('events/detailajax/') . $agenda_id ?>",
