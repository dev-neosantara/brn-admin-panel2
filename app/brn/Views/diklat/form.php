...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Tambah Data Diklat</h6>
    </div>
    <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="name">Judul Diklat</label>
                        <input type="text" class="form-control form-control-user" id="name" tabindex="0" placeholder="Pelatihan satu" name="name" value="<?php echo isset($data) && isset($data->name) ? $data->name : '' ?>">
                    </div>
                    <div class="form-group">
                        <label for="description">Deskripsi Diklat</label>
                    ...
                    <div class="form-group">
                        <label for="level">Minimum Level Diklat yang dibutuhkan</label>
                        <input type="number" min="1" name="level" id="level" placeholder="1">
                    </div>
                </div>
                <div class="col-md-6">
